        ...
        <div className="flex justify-center items-center mt-60">
          ...
          <dialog id="my_modal_1" className="modal">
            <div className="modal-box">
              ...
              <p className="py-4">if you download a file, you can not edit a file and all your data is deleted.</p>
              <div className="modal-action p-1.5 ">
                <form method="dialog">
                  <button className="btn m-2 btn-error" >DENY</button>
                  <button className="btn btn-success" onClick={() => {
                    setoncetime(false)
                    window.location.href = `${ip}/download/Cyberpunk.mp4`
          ...
          <a href={`${ip}/download/Cyberpunk.mp4`}><button className="btn btn-success w-500 text-lg text-zinc-100">DOWLOAD</button></a>
        </div>
      }
    </>
  );
