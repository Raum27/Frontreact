...
import hero from 'C:/Users/Raum/Desktop/FRONT/src/assets/he1.jpg'
            ...
            <div className="hero min-h-dvh bg-base-200">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div>
                        ...
                        <Link to="/UPLOADIMAGE">  <button className="btn btn-primary">Start image</button></Link>
                    </div>
                </div>
            </div>
            ...
            <div className="hero min-h-lvh" style={{ backgroundImage: `url(${momo})` }}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        ...
                        <Link to="/UPLOADVIDEO"><button className="btn btn-primary">Start video</button></Link>
                    </div>
                </div>
            </div>
